...
<head>
    ...
    <link rel="stylesheet" href="../player/css/art.css">
    <script src="../player/js/jquery.min.js"></script>
    <script src="../player/js/hls.min.js"></script>
    <script src="../player/js/artplayer.js"></script>
    <script src="../player/js/art.js"></script>
    <?php if($MacCmsBox["danmuon"] !== 1){echo "<script src='../player/js/artplayer-danmuku.js'></script>";} ?>
    <style>
        <?php
